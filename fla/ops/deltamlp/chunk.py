...
def chunk_deltamlp_fwd(
    ...
    _, o_oja, Avv, hkt = chunk_oja2_fwd(
        q=q,
        k=k,
        v=w,
        gv=g,
    ...
    p = softmax_fwd(o_oja, dtype=torch.float)

    qv = p.to(q.dtype)
    _, o_delta, Aqk, Akk, hvt = chunk_kda_fwd(
        q=qv,
        k=w,
        v=v,
        g=g,
    ...
    return o_oja, o_delta, p, Avv, Aqk, Akk, hkt, hvt
...
def chunk_gsa2_bwd(
    ...
    qv = p.to(q.dtype)
    dqv, dw, dv, db, dgk, dhv0 = chunk_kda_bwd(
        q=qv,
        k=w,
        v=v,
        g=g,
    ...
    do_oja = softmax_bwd(p, dqv, dtype=o_oja.dtype)

    dq, dk, dw_oja, db_oja, dg, dhk0 = chunk_oja2_bwd(
        q=q,
        k=k,
        v=w,
        gv=g,
...
class ChunkGSA2Function(torch.autograd.Function):
    ...
    def forward(
        ...
        o_oja, o_delta, p, Avv, Aqk, Akk, hkt, hvt = chunk_gsa2_fwd(
            q=q,
            k=k,
            v=v,
            w=w,
    ...
    def backward(ctx, dov, dhkt=None, dhvt=None):
        ...
        dq, dk, dv, dw, dg, dbeta, dhk0, dhv0 = chunk_gsa2_bwd(
            q=q,
            k=k,
            v=v,
            w=w,
...
def chunk_deltamlp(
    ...
    o, *final_state = ChunkGSA2Function.apply(
        q,
        k,
        v,
        w,
